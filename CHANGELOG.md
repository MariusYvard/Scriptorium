...
Contrôle de ce qu'un livrable trahit de son auteur avant envoi, détection des caractères invisibles. Ces mécanismes réimplémentent à neuf des idées observées dans le projet watermarks-remover de Guillaume Meyer (MIT), en les retournant du côté du contrôle : le projet d'origine efface les traces d'un fichier, Scriptorium les signale à son auteur et ne nettoie pas.
