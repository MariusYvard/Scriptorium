...
- Harnais extensible : evals/run-evals.py exécute désormais chaque module de evals/cas/ en plus de son fichier unique, qui reste le socle. Les evals passent de 126 à 210 cas. Nouveaux générateurs de fixtures régénérables evals/fixtures/generer-gabarits-formats.py (pptx, odt, pdf) et evals/fixtures/generer-pdf.py.
