...
4. Les evals passent au vert avant toute proposition : `python3 evals/run-evals.py` (92 cas, hors ligne). Un mécanisme déterministe nouveau arrive avec son cas d'eval.
