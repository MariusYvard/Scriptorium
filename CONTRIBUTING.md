...
4. Les evals passent au vert avant toute proposition : `python3 evals/run-evals.py` (457 cas, hors ligne). Un mécanisme déterministe nouveau arrive avec son cas d'eval ; un nouveau lot de cas se range dans un module de `evals/cas/` plutôt que d'allonger le fichier unique.
