...
name: controler
description: >
  Éprouve, contrôle et corrige un écrit avant publication. Six sous-commandes. revue : revue adversariale et contrôle qualité (carte preuve-affirmation, sévérité, verdict, lettre de décision) "révise mon texte", "ce texte est-il prêt", "critique mon écrit", "review my draft", "is this ready to submit", "peer review this paper", "proofread this". contredire : contradiction la plus forte d'une thèse, modèle de Toulmin, discipline de concession, points de rupture "joue l'avocat du diable", "conteste ma thèse", "où est la faille", "play devil's advocate", "challenge my argument", "steelman the objection". consensus : vote de trois agents sur contrat de notation préenregistré, comparaison par paires, ancré sur le scorecard, profils de discipline "revue par consensus", "double validation", "consensus review", "get a second opinion". humaniser : détecter et corriger l'empreinte d'un texte généré "ça sonne IA", "enlève les tics d'écriture", "this sounds AI-generated", "remove the AI tells". audit : noter un PDF, un Word ou un deck existant (scorecard, contrôles, originalité), vérifier la conformité à un gabarit imposé, contrôler ce que le fichier trahit de son auteur avant envoi et la déclaration de disponibilité des données avant soumission "audite ce document", "note ce rapport", "est-ce que ça respecte le modèle imposé", "qu'est-ce que ce fichier dit de moi", "audit this document", "score this report", "does it follow the required template", "what does this file reveal about me", "check the data availability statement". relecteurs : réponse point par point, registre d'engagements, re-revue avec trajectoire de score "réponds aux relecteurs", "reply to the reviewers", "point-by-point response", "rebuttal letter". Déclencheurs français et anglais. La langue du document se lit, elle ne se déduit pas de la langue de la conversation. Sert le chercheur, l'ingénieur et l'analyste géopolitique.
metadata:
  version: "0.14.0"
---
...
La langue de la conversation ne fixe pas la langue du document. Une demande formulée en anglais sur un rapport rédigé en français reste une notation française. Lire la langue dans cet ordre : pragme `lint-style:langue=` du fichier contrôlé, puis `projet.json`, puis question fermée à l'utilisateur. Ne pas retomber en silence sur le français quand le texte examiné est manifestement anglais : le signaler et demander confirmation. Un texte anglais noté avec les règles françaises rend un score faux dans les deux sens (voir `produire/references/langue.md`).
