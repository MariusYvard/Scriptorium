...
name: cadrer
description: >
  Cadre un projet d'écrit avant toute rédaction : établit le brief, applique les cinq filtres de délimitation, formule la problématique en question fermée, choisit le genre et produit un plan validé. À utiliser quand l'utilisateur demande "cadre mon rapport", "délimite mon sujet", "aide-moi à structurer", "quel plan pour", "formule ma problématique", "par où commencer mon mémoire" ou commence un document sans périmètre clair.
metadata:
  version: "0.1.0"
---
