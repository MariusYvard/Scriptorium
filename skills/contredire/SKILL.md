...
name: contredire
description: >
  Soumet une thèse à la contradiction la plus forte avant ou après la rédaction : construit la contre-thèse, applique le modèle de Toulmin, nomme la preuve la plus faible et l'objection non traitée, propose le contre-argument que ferait un évaluateur hostile. À utiliser quand l'utilisateur demande "joue l'avocat du diable", "conteste ma thèse", "contre-argumente", "où est la faille", "steelman l'opposition", "quelles objections" ou veut éprouver la solidité d'un raisonnement.
metadata:
  version: "0.1.0"
---
...
- Le saut logique : où passe-t-on d'une corrélation à une causalité, d'un cas au général ?
...
Points de rupture, par gravité :
1. [grave] [faille] -> Parade : [renforcer, nuancer, ou concéder]
2. [moyen] [faille] -> Parade : ...

Verdict : la thèse tient / tient sous conditions / doit être nuancée.
```

## 5. Boucler avec la rédaction
