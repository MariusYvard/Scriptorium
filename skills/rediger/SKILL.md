...
name: rediger
description: >
  Moteur de rédaction unifié qui charge le playbook du genre demandé et produit le texte en appliquant la méthodologie d'ingénierie textuelle et le style maison. À utiliser quand l'utilisateur demande "rédige un rapport scientifique", "écris un article", "rédige un long rapport", "rédige une analyse stratégique", "rédige un rapport de prospective", "rédige une étude de cas", "rédige la section méthode", "écris l'introduction" ou veut produire ou réécrire un écrit de haut niveau.
metadata:
  version: "0.1.0"
---
...
Si le plan n'est pas posé, lancer d'abord `cadrer`. Si les preuves ne sont pas réunies, lancer d'abord `sourcer`. Rédiger sans plan ni preuve produit du remplissage.
...
5. À la fin d'une passe, enchaîner vers `reviser` pour la revue adversariale.
