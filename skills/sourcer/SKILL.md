...
name: sourcer
description: >
  Recherche, pondère et vérifie les sources d'un écrit, extrait les faits, formate les citations et construit la carte preuve-affirmation. À utiliser quand l'utilisateur demande "trouve des sources", "vérifie ce fait", "ajoute des citations", "construis la bibliographie", "sources fiables sur", "vérifie mes références" ou quand un texte avance des affirmations non étayées.
metadata:
  version: "0.1.0"
---
