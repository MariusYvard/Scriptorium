...
name: style-maison
description: >
  Génère, applique ou fait respecter la charte éditoriale. Produit une charte "Nous écrivons / Nous n'écrivons pas" à partir d'écrits existants, applique le style maison à un texte, ou contrôle la conformité d'un texte aux directives. À utiliser quand l'utilisateur demande "génère ma charte éditoriale", "applique le style maison", "harmonise le ton", "extrais mon style", "ce texte est-il dans mon style", "uniformise la voix" ou "réécris dans mon style".
metadata:
  version: "0.1.0"
---
